    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4">🎮 Deine Fortschritte</h2>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow cursor-pointer"
            ...
            <p className="text-sm text-gray-600">Starte ein AI-Gespräº¤ch und sammle XP</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow cursor-pointer"
            ...
            <p className="text-sm text-gray-600">Wäº¤hle ein Thema zum vertieften Lernen</p>
          </div>
